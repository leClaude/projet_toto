<div class="container mt-5">
  <form action="" method="post" class="card w-75 mx-auto">
    <h4 class="bg-primary text-white card-header text-center">CONNEXION</h4>
    ...
    <div class="form-inline d-flex justify-content-between mt-2">
      ...
      <input type="password" class="form-control w-75 mr-2" name="password" placeholder="8 caractères mini" value="" required>
    </div>
